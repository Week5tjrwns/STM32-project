...
데이터시트만 보고 레지스터 주소를 찾아서 매크로로 정의하고 설정하는 법을 익혔습니다.

RTOS에서 여러 태스크가 동시에 돌 때, Mutex 없이 전역 변수를 공유하면 데이터가 꼬일 수 있다는 점을 배우고 동기화의 중요성을 알게 되었습니다.

단순히 코드를 짜는 것보다, 정상 시나리오와 비정상 시나리오를 구분해서 예외 처리를 하는 것이 임베디드 SW의 핵심임을 배웠습니다.
